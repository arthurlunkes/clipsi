...
import { Menu, Bell, PanelLeftClose, PanelLeftOpen } from 'lucide-vue-next'
...
<template>
  ...
  >
    ...
    <div class="flex items-center gap-2">
      ...
      >
        <Bell :size="20" />
        <span class="absolute top-1.5 right-1.5 w-2 h-2 bg-[#EF4444] rounded-full ring-2 ring-white animate-pulse" aria-hidden="true" />
      </button>

      <div class="flex items-center gap-2.5 pl-2.5 border-l border-[#E7E9F2]">
        <div class="w-9 h-9 rounded-full gradient-primary flex items-center justify-center text-white text-xs font-bold shadow-primary ring-2 ring-white" aria-hidden="true">
          PS
        </div>
